...
- `tests.conftest.FakeLLMConnector`를 주입하면 문범석 모듈 없이 기능을 개발할 수 있습니다.
...
tests            실제 Ollama 서버를 쓰지 않는 단위·통합 테스트
scripts          합성 샘플 생성기
...
모든 테스트는 Fake 또는 주입된 callable을 사용해 실제 Ollama 서버를 호출하지 않습니다.
